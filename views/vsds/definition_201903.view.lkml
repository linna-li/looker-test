# The name of this view in Looker is "Definition 201903"
...
# The name of this view in Looker is "Definition 201903 Parents"
view: definition_201903__parents {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Definition 201903 Parents" in Explore.
...
# The name of this view in Looker is "Definition 201903 Synonyms"
...
# The name of this view in Looker is "Definition 201903 Glossary"
...
# The name of this view in Looker is "Definition 201903 Children"
view: definition_201903__children {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Definition 201903 Children" in Explore.
...
# The name of this view in Looker is "Definition 201903 Title Part"
view: definition_201903__title_part {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Definition 201903 Title Part" in Explore.
...
# The name of this view in Looker is "Definition 201903 Definition"
view: definition_201903__definition {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Definition 201903 Definition" in Explore.
...
# The name of this view in Looker is "Definition 201903 Child Groups"
...
# The name of this view in Looker is "Definition 201903 Synonyms Target"
view: definition_201903__synonyms__target {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Definition 201903 Synonyms Target" in Explore.
...
# The name of this view in Looker is "Definition 201903 Glossary Target"
view: definition_201903__glossary__target {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Definition 201903 Glossary Target" in Explore.
...
# The name of this view in Looker is "Definition 201903 Residual References"
...
# The name of this view in Looker is "Definition 201903 Limiting References"
...
# The name of this view in Looker is "Definition 201903 Child Groups Symbols"
view: definition_201903__child_groups__symbols {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Definition 201903 Child Groups Symbols" in Explore.
...
# The name of this view in Looker is "Definition 201903 Informative References"
...
# The name of this view in Looker is "Definition 201903 Application References"
...
# The name of this view in Looker is "Definition 201903 Residual References Target"
view: definition_201903__residual_references__target {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Definition 201903 Residual References Target" in Explore.
...
# The name of this view in Looker is "Definition 201903 Limiting References Target"
view: definition_201903__limiting_references__target {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Definition 201903 Limiting References Target" in Explore.
...
# The name of this view in Looker is "Definition 201903 Informative References Target"
view: definition_201903__informative_references__target {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Definition 201903 Informative References Target" in Explore.
...
# The name of this view in Looker is "Definition 201903 Application References Target"
view: definition_201903__application_references__target {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Definition 201903 Application References Target" in Explore.
