# The name of this view in Looker is "Vsds Bug Input Data Model Training"
view: vsds_bug_input_data_model_training {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `vsds.vsds_bug_input_data_model_training` ;;
