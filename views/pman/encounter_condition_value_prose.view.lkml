# The name of this view in Looker is "Encounter Condition Value Prose"
view: encounter_condition_value_prose {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: pman.encounter_condition_value_prose ;;
