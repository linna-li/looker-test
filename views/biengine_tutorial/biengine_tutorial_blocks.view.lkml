# The name of this view in Looker is "Biengine Tutorial Blocks"
view: biengine_tutorial_blocks {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `biengine_tutorial.blocks` ;;
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # This dimension will be called "Bits" in Explore.
