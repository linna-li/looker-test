# The name of this view in Looker is "Lrjjxfo1768489511123 Order Itemsrollup Order ID Orders S"
view: lrjjxfo1768489511123_order_itemsrollup__order_id__orders_s {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: tmp.LR$JJXFO1768489511123_order_items$rollup__order_id__orders_s ;;
