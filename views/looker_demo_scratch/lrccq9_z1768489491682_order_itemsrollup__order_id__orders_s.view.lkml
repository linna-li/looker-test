# The name of this view in Looker is "Lrccq9 Z1768489491682 Order Itemsrollup Order ID Orders S"
view: lrccq9_z1768489491682_order_itemsrollup__order_id__orders_s {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: looker_demo_scratch.LR$CCQ9Z1768489491682_order_items$rollup__order_id__orders_s ;;
