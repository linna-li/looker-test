# The name of this view in Looker is "Lrvhm2 B1768488992352 Order Itemsrollup Order ID Orders St"
view: lrvhm2_b1768488992352_order_itemsrollup__order_id__orders_st {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: looker_demo_scratch.LR$VHM2B1768488992352_order_items$rollup__order_id__orders_st ;;
