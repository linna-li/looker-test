# The name of this view in Looker is "Lrcc74 P1768487303638 Order Itemsrollup Order ID"
view: lrcc74_p1768487303638_order_itemsrollup__order_id {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: looker_demo_scratch.LR$CC74P1768487303638_order_items$rollup__order_id ;;
