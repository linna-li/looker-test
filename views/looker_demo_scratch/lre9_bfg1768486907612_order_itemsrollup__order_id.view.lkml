# The name of this view in Looker is "Lre9 Bfg1768486907612 Order Itemsrollup Order ID"
view: lre9_bfg1768486907612_order_itemsrollup__order_id {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: looker_demo_scratch.LR$E9BFG1768486907612_order_items$rollup__order_id ;;
