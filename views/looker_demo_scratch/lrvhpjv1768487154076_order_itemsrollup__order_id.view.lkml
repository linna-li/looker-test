# The name of this view in Looker is "Lrvhpjv1768487154076 Order Itemsrollup Order ID"
view: lrvhpjv1768487154076_order_itemsrollup__order_id {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: looker_demo_scratch.LR$VHPJV1768487154076_order_items$rollup__order_id ;;
