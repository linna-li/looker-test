# The name of this view in Looker is "Churn Telco Input Data Model Training"
view: churn_telco_input_data_model_training {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `vsdstdoct13.ChurnTelco_input_data_model_training` ;;
