# The name of this view in Looker is "Penguin Model Input Data Model Training"
view: penguin_model_input_data_model_training {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `vsdstdoct13.Penguin_Model_input_data_model_training` ;;
